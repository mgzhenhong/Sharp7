    ...
    public static class S7
    {
        ...
        public static int DataSizeByte(this int wordLength) {
            return wordLength switch {
                (int)S7WordLength.Bit => 1,// S7 sends 1 byte per bit
                (int)S7WordLength.Byte => 1,
                (int)S7WordLength.Char => 1,
                (int)S7WordLength.Word => 2,
                (int)S7WordLength.DWord => 4,
                (int)S7WordLength.Int => 2,
                (int)S7WordLength.DInt => 4,
                (int)S7WordLength.Real => 4,
                (int)S7WordLength.Counter => 2,
                (int)S7WordLength.Timer => 2,
                _ => 0,
            };
        }
